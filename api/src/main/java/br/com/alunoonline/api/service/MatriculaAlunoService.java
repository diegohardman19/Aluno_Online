...
public class MatriculaAlunoService {
    ...
    public void newMatricula(MatriculaAluno matriculaAluno) {
        matriculaAluno.setStatus(
                MatriculaAlunoStatusEnum.MATRICULADO);
        matriculaAlunoRepository.save(matriculaAluno);
    }

    public void trancarMatriculaAluno(Long id){
        // Verifica se existe:
        MatriculaAluno matricula = matriculaAlunoRepository
                .findById(id)
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));

        // troca o status de fato
    ...
    public HistoricoAlunoResponseDTO emitirHistorico(Long alunoId) {
        ...
        historico.setTipoDocumento(aluno.getTipoDocumento());
        historico.setNumeroDocumento(aluno.getNumeroDocumento());
